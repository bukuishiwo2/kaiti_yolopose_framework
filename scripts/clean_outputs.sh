...
rm -rf "$ROOT_DIR/outputs/eval_urfall" "$ROOT_DIR/outputs/eval_urfall_track" "$ROOT_DIR/outputs/eval_urfall_sequence"
rm -rf "$ROOT_DIR/outputs/tune_fall_grid" "$ROOT_DIR/outputs/tune_fall_grid_predict"
